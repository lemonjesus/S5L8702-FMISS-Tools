...
const char knownInstructions[] = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x11, 0x13, 0x14, 0x17, 0x18, 0x19};
uint32_t known = 0;
...
void explain_instruction(uint32_t address) {
    ...
    case 0x17:
        ...
        break;
    case 0x18:
        printf("read r%d = *(r%d)", cmd.arg1, cmd.arg2);
        break;
    case 0x19:
        printf("write *(r%d) = r%d", cmd.arg2, cmd.arg1);
        break;
    default:
